...
include 'conexion.php';
    $proyectos = "";
    $consulta = "SELECT p.idProyecto, p.nombreproyecto, p.descripcion, m.rutaImagen FROM `proyecto` p INNER JOIN multimediaproyecto m ON p.idProyecto=m.Proyecto_idProyecto";
