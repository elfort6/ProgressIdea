...
<body>
    ...
    <div class="jumbotron p-4 p-md-5 text-white container" style="background-image: url(img/l.jpg);background-size: cover;">
            <div class="col-md-6 px-0">
                <h1 class="display-4 font-italic">Recuperacion de cuenta.</h1>
                <p class="lead my-3">Se ha enviado un correo de recuperacion, por favor revisa tu bandeja de entrada y tambien la seccion de SPAM.</p>
            </div>
        </div>
