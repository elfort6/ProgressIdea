  ...
  <body>
    ...
    <script>
      ...
      function redireccionar(nonce,monto,idp){
            location.href= "login.phphttps://elfort6.000webhostapp.com/api-pagos/servidor.php?nonce="+nonce+"&monto="+,monto+"&idp="+idp+"";
        }
      ...
      braintree.dropin.create({
           ...
           button.addEventListener('click', function () {
            dropinInstance.requestPaymentMethod(function (requestPaymentMethodErr, payload) {
              ...
              redireccionar(payload.nonce,<?php echo $_POST['montoApoyo']?>,<?php echo $_POST['idProyecto']?>);
              //form.submit();
            });
          });
