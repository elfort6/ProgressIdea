        ...
        <div class="row">
            <div class="col-md-7">
                <div class="input-group mt-2 mt-lg-0">
                    <input class="form-control" type="text" id="busqueda" name="busqueda" placeholder="Search" aria-label="Search" onkeypress="buscarEnter(event);">
    ...
    <script type="text/javascript">
        (function() {
            $.post('../Ajax/php/obtenerCategoria.php',{},function(data){
                ...
                $("#categoria").html(categoria+data);
            });

            $.post('../Ajax/php/BusquedaPatrocinador.php', {"categoria":0}, function(data) {
        ...
        function buscar(){
            ...
            if (texto == null){
                ...
                objeto = {"busqueda": texto,"categoria":categoria};
            }
            $.post('../Ajax/php/BusquedaPatrocinador.php', objeto, function(data) {
