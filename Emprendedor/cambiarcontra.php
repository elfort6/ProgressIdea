        ...
        <div class="card tarjeta">
            ...
            <div class="card-body col-lg-12 pt-4 pb-5">
                ...
                <div class="col-lg-12" id="form">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="password" id="contra1" name="contra1" placeholder="" required=" ">
                        <div class="valid-feedback">¡Ok válido!</div>
                        <div class="invalid-feedback">No Valido.</div>
                    </div>
                    <label>Repetir contraseña nueva</label>
                    <div class="form-group">
                        <input class="form-control" type="password" id="contra2" name="contra2" placeholder="" required=" ">
                        <div class="valid-feedback">¡Ok válido!</div>
                        <div class="invalid-feedback">No Valido.</div>
                    </div>
